...
XS_EUPXS(XS_Template__Stash__XS_get); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Template__Stash__XS_get)
{
    dVAR; dXSARGS;
    if (items < 2)
       croak_xs_usage(cv,  "root, ident, ...");
    {
	SV *	root = ST(0)
;
	SV *	ident = ST(1)
...
XS_EUPXS(XS_Template__Stash__XS_set); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Template__Stash__XS_set)
{
    dVAR; dXSARGS;
    if (items < 3)
       croak_xs_usage(cv,  "root, ident, value, ...");
    {
	SV *	root = ST(0)
;
	SV *	ident = ST(1)
...
extern "C"
#endif
XS_EXTERNAL(boot_Template__Stash__XS); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_Template__Stash__XS)
{
    dVAR; dXSARGS;
    ...
    XS_VERSION_BOOTCHECK;
        ...
        newXS("Template::Stash::XS::get", XS_Template__Stash__XS_get, file);
        newXS("Template::Stash::XS::set", XS_Template__Stash__XS_set, file);
#if (PERL_REVISION == 5 && PERL_VERSION >= 9)
  if (PL_unitcheckav)
